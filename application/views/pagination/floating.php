...
<p class="pagination">
    ...
    <?php if ($first_page !== FALSE): ?>
        <a class="first" href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first"><?php echo __('First') ?></a>
    <?php else: ?>
        <span class="first"><?php echo __('First') ?></span>
    <?php endif ?>

    <?php if ($previous_page !== FALSE): ?>
        <a class="prev" href="<?php echo HTML::chars($page->url($previous_page)) ?>"
           rel="prev"><?php echo __('Previous') ?></a>
       <?php else: ?>
        <span class="prev"><?php echo __('Previous') ?></span>
    <?php endif ?>
    ...
    <?php if ($last_page !== FALSE): ?>
        <a class="last" href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('Last') ?></a>
    <?php else: ?>
        <span class="last"><?php echo __('Last') ?></span>
    <?php endif ?>
