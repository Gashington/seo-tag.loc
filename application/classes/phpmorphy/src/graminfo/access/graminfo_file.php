...
class phpMorphy_Graminfo_File extends phpMorphy_Graminfo {
    ...
    function readGramInfoHeader($offset) {
        ...
        $result = unpack(
                'vid/vfreq/vforms_count/vpacked_forms_count/vancodes_count/vancodes_offset/vancodes_map_offset/vaffixes_offset/vaffixes_size/vbase_size', fread($__fh, 20)
        );
