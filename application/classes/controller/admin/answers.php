...
class Controller_Admin_Answers extends Controller_Admin {
    ...
    public function action_index() {
        ...
        $content = View::factory('admin/answers/index', array(
    ...
    public function action_edit() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if($post->check()){
                ...
                $this->request->redirect('admin/answers/');
            }
            $this->errors = $post->errors('validation');
        }
        $content = View::factory('admin/answers/edit',array(
            'reviews' => $reviews,
        ))->bind('post', $post);
        // Вывод в шаблон
        $this->template->errors = $this->errors;
    ...
    public function action_add() {
        ...
        $content = View::factory('admin/answers/add'
        )->bind('post', $post);
        // Вывод в шаблон
        $this->template->errors = $this->errors;
        $this->template->content = array($content);
